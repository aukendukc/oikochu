"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,n){n.d(t,{ET:function(){return sT},IO:function(){return sr},JU:function(){return iL},PL:function(){return sw},QT:function(){return sy},Xo:function(){return sl},ad:function(){return iF},ar:function(){return ss},cf:function(){return sI},hJ:function(){return ix},oe:function(){return sE},r7:function(){return s_}});var r,i,s,a,o=n(9279),l=n(2680),u=n(9053),h=n(3943),c=n(6552),d=n(4575);n(5566);var f=n(9109).lW;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sy(e){e=iS(e,iD);let t=iS(e.firestore,iO);return(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new id({next:o=>{s.Za(),t.enqueueAndForget(()=>rq(e,a));let l=o.docs.has(n);!l&&o.fromCache?i.reject(new A(C.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&o.fromCache&&r&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(o)},error:e=>i.reject(e)}),a=new rK(e5(n.path),s,{includeMetadataChanges:!0,_a:!0});return rU(e,a)})(await iw(e),e.asyncQueue,t,n,r)),r.promise})(iP(t),e._key).then(n=>sA(t,e,n))}class sv extends sd{constructor(e){super(),this.firestore=e}convertBytes(e){return new iU(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iD(this.firestore,null,t)}}function sw(e){e=iS(e,ib);let t=iS(e.firestore,iO),n=iP(t),r=new sv(t);return se(e._query),(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new id({next:n=>{s.Za(),t.enqueueAndForget(()=>rq(e,a)),n.fromCache&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),a=new rK(n,s,{includeMetadataChanges:!0,_a:!0});return rU(e,a)})(await iw(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new sg(t,r,e,n))}function s_(e,t,n,...r){e=iS(e,iD);let i=iS(e.firestore,iO),s=iY(i);return sC(i,[("string"==typeof(t=(0,h.m9)(t))||t instanceof iq?function(e,t,n,r,i,s){let a=e.Qu(1,t,n),o=[i2(t,r,n)],l=[i];if(s.length%2!=0)throw new A(C.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(i2(t,s[e])),l.push(s[e+1]);let u=[],c=eO.empty();for(let e=o.length-1;e>=0;--e)if(!i8(u,o[e])){let t=o[e],n=l[e];n=(0,h.m9)(n);let r=a.Nu(t);if(n instanceof iX)u.push(t);else{let e=iJ(n,r);null!=e&&(u.push(t),c.set(t,e))}}return new iG(c,new eo(u),a.fieldTransforms)}(s,"updateDoc",e._key,t,n,r):function(e,t,n,r){let i=e.Qu(1,t,n);i1("Data must be an object, but it was:",i,r);let s=[],a=eO.empty();return ee(r,(e,r)=>{let o=i3(t,e,n);r=(0,h.m9)(r);let l=i.Nu(o);if(r instanceof iX)s.push(o);else{let e=iJ(r,l);null!=e&&(s.push(o),a.set(o,e))}}),new iG(a,new eo(s),i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tx.exists(!0))])}function sE(e){return sC(iS(e.firestore,iO),[new tz(e._key,tx.none())])}function sT(e,t){var n;let r=iS(e.firestore,iO),i=iL(e),s=(n=e.converter)?n.toFirestore(t):t;return sC(r,[(function(e,t,n,r,i,s={}){let a,o;let l=e.Qu(s.merge||s.mergeFields?2:0,t,n,i);i1("Data must be an object, but it was:",l,r);let u=iZ(r,l);if(s.merge)a=new eo(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=i2(t,r,n);if(!l.contains(i))throw new A(C.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);i8(e,i)||e.push(i)}a=new eo(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new iQ(new eO(u),a,o)})(iY(e.firestore),"addDoc",i._key,s,null!==e.converter,{}).toMutation(i._key,tx.exists(!1))]).then(()=>i)}function sI(e,...t){var n,r,i;let s,a,o;e=(0,h.m9)(e);let l={includeMetadataChanges:!1,source:"default"},u=0;"object"!=typeof t[0]||iM(t[u])||(l=t[u],u++);let c={includeMetadataChanges:l.includeMetadataChanges,source:l.source};if(iM(t[u])){let e=t[u];t[u]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[u+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[u+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}if(e instanceof iD)a=iS(e.firestore,iO),o=e5(e._key.path),s={next:n=>{t[u]&&t[u](sA(a,e,n))},error:t[u+1],complete:t[u+2]};else{let n=iS(e,ib);a=iS(n.firestore,iO),o=n._query;let r=new sv(a);s={next:e=>{t[u]&&t[u](new sg(a,r,n,e))},error:t[u+1],complete:t[u+2]},se(e._query)}return function(e,t,n,r){let i=new id(r),s=new rK(t,i,n);return e.asyncQueue.enqueueAndForget(async()=>rU(await iw(e),s)),()=>{i.Za(),e.asyncQueue.enqueueAndForget(async()=>rq(await iw(e),s))}}(iP(a),o,c,s)}function sC(e,t){return function(e,t){let n=new S;return e.asyncQueue.enqueueAndForget(async()=>r4(await iv(e).then(e=>e.syncEngine),t,n)),n.promise}(iP(e),t)}function sA(e,t,n){let r=n.docs.get(t._key),i=new sv(e);return new sm(e,i,t._key,r,new sf(n.hasPendingWrites,n.fromCache),t.converter)}new WeakMap,function(e=!0){g=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new iO(new D(t.getProvider("auth-internal")),new V(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new A(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ev(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,"4.7.3",void 0),(0,o.KN)(m,"4.7.3","esm2017")}()}}]);